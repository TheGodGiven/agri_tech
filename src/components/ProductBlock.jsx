...
export default function ProductBlock(props) {
    return (
        <>
            <div className="container mx-[95px] mt-[60px] mb-[40px]">
                <div className="flex gap-x-12 ">
                    <div className="w-[50%]">
                        <div className="text-[24px] font-semibold bg-[#C7FF1D] text-[#484C52] rounded-[12px] p-2 max-w-max">
                            {props.lg == 'ru' && 'Наша продукция'}
                            {props.lg == 'en' && 'Our products'}
                            {props.lg == 'kz' && 'Біздің өнімдер'}
                        </div>
                        <div className="mt-[16px] text-[32px] font-bold">
                        ...
                        <div className="mt-[32px] text-[20px]">
                    ...
                    <div className="w-[50%]">
                        <p className="bg-[#E6EAEE] p-4 max-w rounded-[16px] text-[16px] font-semibold">
                            {props.lg == 'ru' && '1. Два этапа экстракции'}
                            {props.lg == 'en' && '1. Two stages of extraction'}
                            {props.lg == 'kz' && '1. Екі кезеңді экстракция'}
                        </p>
                        <p className="bg-[#E6EAEE] p-4 max-w rounded-[16px] text-[16px] font-semibold mt-4">
                ...
                <div className="flex gap-x-[66px] mt-[40px]">
                    <div className='w-1/2'>
                        <img src={ProductsPoundImage} alt="ProductsPoundImage" className='rounded-2xl'/>
                    </div>
                    <div className='w-1/2'>
                ...
                <div className='flex gap-x-[52px] mt-[40px]'>
                    <div className='w-1/2'>
                        <img src={ProductsCharacterImage} alt="ProductsCharacterImage" className='rounded-2xl'/>
                    </div>
                    <div>
                        ...
                        <div className='flex flex-col gap-y-[16px]'>
                            <div className="bg-[#E6EAEE] p-4 max-w rounded-[16px] text-[16px] font-semibold flex justify-around">
                                <p>Protein (%mfb)</p>
                                <p>92</p>
                            </div>
                            <div className="bg-[#E6EAEE] p-4 max-w rounded-[16px] text-[16px] font-semibold flex justify-around">
                        ...
                        <div className='text-[16px] font-semibold flex items-center justify-center mt-[24px] bg-[#252D30] py-4 rounded-[50px] text-white'>
